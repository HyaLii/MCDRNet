...
if __name__ == '__main__':
    ...
    if opt.mode == 0:
        ...
        test_Derain_Dehaze(net, derain_set, task="derain")#Rain100L
    elif opt.mode == 2:
        print('Start testing SOTS...')
        test_Derain_Dehaze(net, derain_set, task="dehaze")#SOTS_outdoor
    elif opt.mode == 3:
        print('Start testing Sigma=15...')
        test_Denoise(net, denoise_set, sigma=15)
